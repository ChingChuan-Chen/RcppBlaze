...
if (suppressMessages(require("RcppLAPACKE", character = TRUE, quietly = TRUE))) {
  ...
  ## use cholesky decomposition to solve linear equation
  exprs$blaze_llt_cblas <- expression(fastLmPure2(mm, y, 2L))
}
...
##        blaze_llt_cblas   40.884076   41.324976   43.76919   43.21980   45.95689   48.13963    20
...
##        blaze_llt_cblas 189.40559 192.76065  207.74746  198.38357  219.36541  260.79429    20
...
##        blaze_llt_cblas  14.656  19.5390  23.58990  21.6075  25.8190   44.851    20
